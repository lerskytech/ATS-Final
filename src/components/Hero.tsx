...
const Hero = () => {
  ...
  return (
    <section 
      ...
      style={{ backgroundImage: `url('https://placehold.co/1920x1080/000000/FFFFFF/png?text=Digital+Excellence')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}
    >
